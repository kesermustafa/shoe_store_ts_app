	...
	return (
		<div className="relative w-full">
			<div className="absolute top-1/2 transform -translate-y-1/2 ps-4 md:ps-6 lg:ps-8 xl:ps-10">
				...
				<h1 className="text-[20px] sm:text-[25px] md:text-[30px] lg:text-[50px] xl:text-[74px] font-semibold text-amber-500">
					%30 indirim
				</h1>
				
				<p className="text-gray font-open text-[11px] sm:text-[12px] lg:text-[18px] xl:text-[20px] max-w-[50%]">
					Rahatınız düşünülerek tasarlanan spor ayakkabılar, bir sonraki seansınıza tüm
					odağınızı verebilmenizi sağlar.
				</p>
			</div>
			
			<img src="/bg.png" className='lg:w-full max-h-[400px]' alt="bg image" />
		</div>
	);
};
